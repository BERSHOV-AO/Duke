 ...
 *  drawingвЂ”methods that draw geometric shapes and methods that
 ...
 *  You save your image to a file using the <em>File в†’ Save</em> menu option.
 ...
 *  call a drawing
 *  methodвЂ”such as {@code point()} or {@code line()}вЂ”the
 ...
 *       the canvas is permittedвЂ”however, only the part of the object that
 ...
 *       from (0.5, вЂ“&infin;) to (0.5, &infin;) may not be visible even in the
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * (<em>x</em><sub>1</sub>, <em>y</em><sub>1</sub>), ...,
     * (<em>x</em><sub><em>n</em>вЂ“1</sub>, <em>y</em><sub><em>n</em>вЂ“1</sub>).
     *
